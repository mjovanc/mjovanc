...
[![My Skills](https://skills.thijs.gg/icons?i=java,reactivex,spring,hibernate,gradle,maven,kotlin,idea,kubernetes,py,django,flask,js,ts,nodejs,express,git,docker,bash,mysql,postgres,sqlite,linux,md,ansible,nginx,jenkins,github,githubactions,gitlab,azure&theme=dark)](https://skills.thijs.gg)
